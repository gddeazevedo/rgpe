...
from . import Command
from ..services import custom_dataset_generator_service, base_dataset_generator_service


class GenerateCustomDatasetCommand(Command):
    def execute(self, *args):
        ...
        custom_dataset_generator_service.generate_custom_dataset()
